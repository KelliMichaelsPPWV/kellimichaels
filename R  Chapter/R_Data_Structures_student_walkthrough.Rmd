...
4.  Print the second column of both matrices.
    ...
    ```{##as a note: for some reason this code was not executing as a block but it works perfectly if I enter one time at a time on the console so I think my environment is just not figured quite correctly}
